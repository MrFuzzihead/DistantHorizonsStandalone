...
public class ClientBlockStateColorCache
{
	...
	private static final ForgeDirection[] COLOR_RESOLUTION_DIRECTION_ORDER = { ForgeDirection.UP, ForgeDirection.NORTH, ForgeDirection.EAST, ForgeDirection.WEST, ForgeDirection.SOUTH, ForgeDirection.DOWN };
